            ...
            <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                    <tr>
                        ...
                        <th className="px-6 py-3 text-center text-xs font-medium tracking-wider text-gray-500 uppercase">Opsi</th>
                    </tr>
                </thead>
                <tbody className="divide-y divide-gray-200 bg-white">
                    {currentItems.map((item: any, index: any) => (
                        ...
                        <tr key={index}>
                            ...
                            <td className="flex flex-row justify-center px-6 py-4 text-sm whitespace-nowrap">
                                {(user.role === 'Admin' || user.id === item.user.id) && (
                                    <button
                                        onClick={() => handleUpdate(item.jadwal_id)}
